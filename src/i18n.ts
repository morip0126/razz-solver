...
const messages = {
  ...
  titleDraw: { ja: 'NL 2-7 シングルドロー', en: 'NL 2-7 Single Draw' },
  subtitleDraw: {
    ja: 'ノーリミット・デュース・トゥ・セブン（HU）ソルバー',
    en: 'No-limit deuce-to-seven single draw (heads-up) solver',
  },
  tabRazz: { ja: 'Razz', en: 'Razz' },
  tabDraw: { ja: 'NL 2-7 SD', en: 'NL 2-7 SD' },
  stack: { ja: 'スタック', en: 'Stack' },
  allin: { ja: 'オールイン', en: 'All-in' },
  pat: { ja: 'パット', en: 'Pat' },
  drawN: { ja: '{n}枚ドロー', en: 'Draw {n}' },
  phasePre: { ja: 'プリドロー', en: 'Pre-draw' },
  phaseDraw: { ja: 'ドロー', en: 'Draw' },
  phasePost: { ja: 'ポストドロー', en: 'Post-draw' },
  nextToActDraw: { ja: '次の手番: {p}', en: 'Next to act: {p}' },
  drawActorTitle: {
    ja: '{p} の戦略 — {phase}',
    en: 'Strategy for {p} — {phase}',
  },
  showdownNote: { ja: 'ショーダウン', en: 'Showdown' },
  legendRaiseNL: { ja: 'ベット/レイズ/オールイン', en: 'Bet/Raise/All-in' },
  drawSpotNote: {
    ja: 'ヘッズアップ（BTN 0.5bb / BB 1bb）。ベットはポットサイズとオールインのみ、ドローは0〜2枚のサイズ抽象化。「計算」で全ツリーを一括ソルブし、以降のノード移動は即時です。',
    en: 'Heads-up (BTN 0.5bb / BB 1bb). Pot-sized bets and all-in only; draws 0-2 (action abstraction). Go solves the entire tree once; navigation is instant afterwards.',
  },
  noteDraw: {
    ja: 'ハンドは（パットの強さ×ドローの質）のクラスに抽象化されます。出現%は手番プレイヤーの到達レンジ内シェア、頻度5%未満は収束ノイズとして省略しています。',
    en: 'Hands are abstracted into (pat strength × draw quality) classes. Weight = share within the acting player\'s arrival range; actions below 5% are dropped as convergence noise.',
  },
